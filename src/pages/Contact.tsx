        ...
        <div className='branch-section'>
          <div className='info-grid'>
            ...
            <div className='address-details'>
              ...
              <p><span className='info-label'>Email</span>: brt@gravelink.com.np</p>
              <p><span className='info-label'>WhatsApp</span>: 9802024996</p>
            </div>
        ...
        <div className='branch-section'>
          <div className='info-grid'>
            ...
            <div className='address-details'>
              ...
              <p><span className='info-label'>Email</span>: ktm@gravelink.com.np</p>
              <p><span className='info-label'>WhatsApp</span>: 9801038868</p>
            </div>
