...
const IconRoller = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 12h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H2v8Z" />
    <path d="M16 12v5a3 3 0 0 1-6 0v-2" />
  </svg>
);

const IconPencil = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="m21.174 6.812-5.908-5.908a2.598 2.598 0 0 0-3.675 0l-3.376 3.377a2.599 2.599 0 0 0 0 3.675l5.909 5.908a2.599 2.599 0 0 0 3.674 0l3.376-3.376a2.598 2.598 0 0 0 0-3.676Z" />
    <path d="m11 11 3 3" />
    <path d="m2 22 2.586-2.586" />
    <circle cx="11" cy="13" r="1" transform="rotate(-45 11 13)" />
  </svg>
);
